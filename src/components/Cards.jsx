...
function Cards({ image, title, price, id, onPlus }) {
	const onAddClicked = () => {
	...
	return (
		<div className='flex flex-wrap justify-center'>
			<div className='hover:-translate-y-3 transition w-64 h-auto p-3 mt-4 ml-4 bg-blue-50 rounded-lg flex flex-col items-start'>
